function show() {
    ...
    if (albums !== null) { show_albums(); }
    else if (eps !== null) { show_eps(); }
    else if (singles !== null) { show_singles(); }
}
...
function show_wiki() {
    ...
    if (eps !== null) { eps.style.display = "none"; }
    if (singles !== null) { singles.style.display = "none"; }
    if (wiki !== null) { wiki.style.display = "block"; }
}
